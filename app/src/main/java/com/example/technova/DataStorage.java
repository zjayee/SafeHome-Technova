...
public class DataStorage {
    ...
    static void populate_helpList()
    {
        ...
        People helper2 = new People("Stephanie Ryder", 25, "Med school student located in Toronto. My safe home is children friendly and close to a few schools. Can house 2 for up to 2 month ", R.drawable.pfp1, R.drawable.cover1);
        ...
        People helper6 = new People("Julie Huang", 28, "Writer from Hamilton. Unsuitable for pets and children. Can house 1 for up to a month. ", R.drawable.juliehuang, R.drawable.cover1);
        People helper7 = new People("Zuri Johnston", 28, "Accountant based in Waterloo. Home can house 2 for up to 3 months. No pets, but children are welcomed. ", R.drawable.zurijohnston, R.drawable.cover1);
        People helper8 = new People("Isabella Knight", 31, "Architect living in Ottawa. Room for one person to stay up to 6 months. ", R.drawable.isabellaknight, R.drawable.cover1);
